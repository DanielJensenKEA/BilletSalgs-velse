...
public void TicketGenerationDoor() {
    ...
    do {
        ...
        if (choice.equals("yes")) {
            ...
            Billet BD1 = new BilletDør(nameSubStr, tempPris, billetID);
            BD1.BeregnBilletPris();
            salg.addTicketsToList(BD1);
...
public void TicketGeneration() { //forsalg og studierabat
    ...
    while (condition) {
        ...
        if (student) {
            ...
            Billet BFSR1 = new BilletForsalgStudRabat(nameSubStr, pris, dageFørKøb, ticketID, studentID);
            BFSR1.BeregnBilletPris();

            System.out.println("The price for your ticket is " + ((BilletForsalgStudRabat) BFSR1).getPris() + ". Would you like to continue? Type yes or no.");
            choice = sc.nextLine().toLowerCase();
            if (choice.equals("yes")) {
                salg.addTicketsToList(BFSR1);
            ...
            int ticketID = generateTicketID();
            Billet BF10D = new BilletForsalg10Dag(nameSubStr, pris, dageFørKøb, ticketID);
            BF10D.BeregnBilletPris();

            System.out.println("The price for your ticket is " + ((BilletForsalg10Dag) BF10D).getPris() + ". Would you like to continue? Type yes or no.");
            choice = sc.nextLine().toLowerCase();
            if (choice.equals("yes")) {
                salg.addTicketsToList(BF10D);
